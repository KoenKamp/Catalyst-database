...
class ElsevierXmlReader(XmlReader):
    ...
    table_caption_css = 'ce|table ce|caption ce|note-para, ce|table ce|caption ce|simple-para'
    table_head_row_css = 'cals|thead cals|row'
    table_body_row_css = 'cals|tbody cals|row'
    table_cell_css = 'ce|entry'
    table_footnote_css = 'ce|table ce|table-footnote ce|note-para, ce|table ce|legend ce|simple-para'
    ...
    def _parse_table_rows(self, els, refs, specials):
        ...
        for row, tr in enumerate(els):
            ...
            for td in self._css(self.table_cell_css, tr):
                ...
                start = int(td.get('namest', '1').strip('col'))
                end = int(td.get('nameend', '1').strip('col'))
                colspan = end - start + 1
