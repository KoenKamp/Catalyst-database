...
class BaseScraper(six.with_metaclass(ABCMeta)):
    ...
    def __init__(self):
        ...
        self.header = {"Accept": "text/html, */*; q=0.01",
        "Accept-Encoding": "gzip, deflate, br",
        "Accept-Language": "nl-NL,nl;q=0.9,en-US;q=0.8,en;q=0.7",
        "Connection": "keep-alive",
        "Content-Type": "application/x-www-form-urlencoded; charset=UTF-8",
        # "Cookie": "ShowEUCookieLawBanner=true; X-Mapping-hhmaobcf=3C9897E0250B6117CDBA3EC8F724E9A9; ASP.NET_SessionId=w5oxlytsrxkaelb3535gcbdo; Branding=50002562; AuthSystemSessionId=b3d3ee55-bb63-4eaa-aa4f-6234b83ad5dd; UserSearchPreferences=SortBy=Relevance&PageSize=25",
        "DNT": '1',
        "Host": "pubs.rsc.org",
        "Origin":"https://pubs.rsc.org",
        "Referer": "https://pubs.rsc.org/en/results?searchtext=test",
        "sec-ch-ua-mobile": "?0",
